...
def main():
	...
	acc_model_data_path = Path(f'/Users/utkarsh/Desktop/Utkarsh/NYU/Year 1/Semester 2/Machine Learning/Labs/Lab 5/usage_files_backup/Ver {version}/infer')
	...
	axs[0, 0].set_xticks(axs[0, 0].get_xticks()[::len(load_output) // 10])
	...
	axs[0, 1].set_ylabel('Response Time (s)')
	axs[0, 1].tick_params(axis='x', rotation=45)
	axs[0, 1].set_xticks(axs[0, 0].get_xticks()[::len(load_output) // 10])
	...
	axs[0, 2].set_xticks(axs[0, 0].get_xticks()[::len(load_output) // 10])
