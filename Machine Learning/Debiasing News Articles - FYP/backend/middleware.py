...
model = torch.load(r"/Users/utkarsh/Desktop/Utkarsh/College/Year 4/FYP/FYPBackend/src/model/my_model.pt")
model.eval()
...
def recieve_text_post():
    try:
        ...
        for sentence in sentence_splitter.split(query):
            ...
            try:
                neutral_response = cached_responses(sentence)
                print(f"found {sentence=} in cache with {neutral_response=}")
            ...
            neutral_responses.append(neutral_response.replace(".", ""))
